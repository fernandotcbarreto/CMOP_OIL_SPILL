...
do comps=1, NCOMP_OIL
      ...
      FRAC_MOL = masscompf2(mm1,ii-1, comps) * PM_OIL_out / (massaf2(mm1,ii-1) * PM_COMP_OIL(comps) )     	! fracao molar do componente na gota  
      ...
      MASSCOMPdropf2(mm1,ii, comps) = MASSCOMPdropf2(mm1,ii-1, comps) - massdis(comps)
      if (MASSCOMPdropf2(mm1,ii, comps).lt.0) then
          MASSCOMPdropf2(mm1,ii, comps) = 0
      endif
     ...
     MASSCOMPf2(mm1,ii, comps)= MASSCOMPf2(mm1,ii-1, comps) - massdis(comps)
     

     if ( MASSCOMPf2(mm1,ii, comps) .le. 0) then
        MASSCOMPf2(mm1,ii, comps) = 0 
     endif 

enddo  

!  print*, 'massdiss', massdis(1), masscomp(jj,ii-1, 1), masscomp(jj,ii,1), ii,jj
!   print*, km_oil, diam_pl, frac_mol
