...
double precision:: gd, bb(2)   !entrainment rate  kg/(m2*s)

double precision:: deltad, viscst, qd, zini, zf1, viscstem, seafrac
...
integer, parameter :: numparcels = 6
